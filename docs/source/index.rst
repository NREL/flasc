...
FLASC: SCADA data analysis toolbox
----------------------------------
...
experiment monitoring. The repository is centrally built around NRELs in-
house `floris <https://github.com/nrel/floris>` wake modeling utility.
...
Example applications of these tools are provided in the `examples/` folder.

See :cite:`ind-Doekemeijer2022a` for a practical example of how the flasc
repository is used or processing and analyses of historical SCADA data of
