...
from flasc.utilities import turbulence_estimator as fsatiestimator
...
if __name__ == "__main__":
    ...
    tb.floris_set_ws_wd_ti(wd=236.0, ws=9.0, ti=0.05)
    ...
    tb.estimate_local_tis(Ns=50, bounds=(0.01, 0.50), refine_with_fmin=True, verbose=True)
